...
#define UE_PROJECT_NAME UEStudyForMMO
#define UE_TARGET_NAME UEStudyForMMOEditor
#define UE_MODULE_NAME "UEStudyForMMO"
...
#define UESTUDYFORMMO_API DLLEXPORT
